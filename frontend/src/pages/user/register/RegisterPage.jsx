...
const userSchema = yup.object().shape({
    ...
    password: yup.string().required('Vui lòng nhập mật khẩu').min(6, 'Mật khẩu phải có ít nhất 6 kí tự').max(32, 'Mật khẩu phải ít hơn hoặc bằng 32 kí tự'),
    confirmPassword: yup
        .string()
                ...
                >
                    <Grid item xs={12} md={3}>
                        ...
                        >
                            ...
                            <Formik initialValues={initialValues} validationSchema={userSchema} onSubmit={handleSubmitForm}>
