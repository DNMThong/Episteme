...
const LoginPage = () => {
    ...
    const clientId = '740015377838-k4vbmt2ulfnr3af2lvokb0evd5v9kcqu.apps.googleusercontent.com';
    useEffect(() => {
        function start() {
            gapi.client.init({
                clientId: clientId,
    ...
    const handleSubmitForm = async (values) => {
        ...
        await login(values)
            ...
            .catch((error) => {
                console.log(error);
                setErrorMessage('Email hoặc mật khẩu không hợp lê! Vui lòng kiểm tra lại!');
            });
    };
    return (
        <>
                ...
                <Grid container alignItems={'center'} justifyContent={'center'}>
                    <Grid item xs={12} md={3} sm={6}>
                        ...
                        >
                            ...
                            {errorMessage && (
                                <Typography variant="h6" component="p" marginBottom={3} sx={{ color: 'red' }}>
                                    {errorMessage}
                                </Typography>
                            )}
                            <Formik initialValues={initialValues} onSubmit={handleSubmitForm} validationSchema={userSchema}>
